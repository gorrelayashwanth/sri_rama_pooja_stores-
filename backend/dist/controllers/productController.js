...
exports.generateImage = exports.importProductsBulk = exports.toggleAvailability = exports.deleteProduct = exports.updateProduct = exports.createProduct = exports.getProductBySlug = exports.getProducts = void 0;
...
const importProductsBulk = async (req, res, next) => {
    try {
        ...
        for (const p of products) {
            if (!p.name || !p.categoryId || !p.price)
                continue;
